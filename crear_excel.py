...
if __name__ == "__main__":
    ...
    # añadimos la media y la predicción
    tabla_pivote2 = df_ingredientes_semana.pivot_table(index='semana')

    # QUIERO INSERTAR LA TABLA EN UNA NUEVA HOJA PERO NO HAY MANERA DE QUE NO SE SOBRE ESCRIBA
    # tabla_pivote2.to_excel('reportev4.xlsx', startrow=4, sheet_name='Ingredientes por semana',)
    wb = load_workbook('reportev4.xlsx') 
